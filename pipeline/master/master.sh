...
PREV_DATE=$(date -v-1H +"%H")

# /Users/krishnasadhu/github-events-analytics/.venv/bin/python
# extract_to_gcs

/opt/homebrew/bin/uv run /Users/krishnasadhu/github-events-analytics/.venv/bin/python -m pipeline.extract.extract_to_gcs --date $CURR_DATE --hour $PREV_DATE

/opt/homebrew/bin/uv run /Users/krishnasadhu/github-events-analytics/.venv/bin/python -m pipeline.transform.stage_1.convert_to_parquet --date $CURR_DATE --hour $PREV_DATE
